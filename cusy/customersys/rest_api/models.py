...
class Class(models.Model):
    ...
    class_name = models.CharField(
        db_column='class_Name', unique=True, max_length=255)
...
class Teacher(models.Model):
    ...
    teacher_id = models.CharField(
        db_column='teacher_id', unique=True, max_length=255)
    teacher_name = models.CharField(db_column='teacher_name', max_length=255)
    teacher_department = models.CharField(
        db_column='teacher_department', max_length=255)
    teacher_phone = models.CharField(db_column='teacher_phone', max_length=255)
    teacher_photo = models.TextField(db_column='teacher_photo')
    is_valided = models.IntegerField(db_column='is_valided')
    teacher_logtime = models.DateTimeField(
        db_column='teacher_logtime', auto_now=True)
...
class ZipfilesInfo(models.Model):
    ...
    zipinfo_type = models.CharField(
        db_column='zipinfo_type', null=True, max_length=255)
