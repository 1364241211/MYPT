...
from .teacher_view import (
    ...
    exportTeacherMTResources,
    exportTeacherAvatarRes,
)
...
teacher_general_api = teacherGeneralApi.as_view({
    'get': 'retrieve',
    'post': 'create'
})
...
teacher_detail = teacherApiViewSet.as_view({'get': 'retrieve'})
teachers = teacherApiViewSet.as_view({
    'get': 'list',
    'post': 'create',
    'put': 'update',
    'delete': 'destroy'
...
validate_Teacher = teacherApiViewSet.as_view({'post': 'updateAll'})
...
urlpatterns = [
    ...
    path('teacherGeneralApi', teacher_general_api, name='teacherApi'),
    path('teacher/<str:param>', teacher_detail, name='teacher-detail'),
    path('teachers', teachers, name='teachers'),
    path('validateTeacher', validate_Teacher),
    path('classGeneralApi', classGeneralApi.as_view()),
    path('classes', classes, name='classes'),
    path('uploadAvatar', uploadAvatar.as_view(), name='avatar'),
    path('uploadTeacherAvatar', uploadTeacherAvatar.as_view(), name='avatar'),
    ...
    path('exportTeacherAll', exportTeacherResources.as_view()),
    path('exportTeacherMTAll', exportTeacherMTResources.as_view()),
    path('exportAvatar', exportAvatarRes.as_view()),
    path('exportAvatar/uuid:str', exportAvatarRes.as_view()),
    path('exportTeacherAvatar', exportTeacherAvatarRes.as_view()),
    path('exportTeacherAvatar/uuid:str', exportTeacherAvatarRes.as_view()),
